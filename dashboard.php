...
<main class="bg-grid">
    ...
    <section class="overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-[#0f1e3c] via-[#1c3f75] to-[#5b9df3] p-6 text-white shadow-xl sm:p-8">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.2em] text-blue-100">Dashboard Peserta</p>
                <h1 class="mt-3 text-3xl font-extrabold leading-tight sm:text-4xl">Selamat Datang di Portal PETA</h1>
    ...
    <section class="mt-6">
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <!-- TES 1 -->
            <div class="rounded-3xl border border-blue-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-slate-800">Tes 1</h3>
            ...
            <!-- TES 2 -->
            <div class="rounded-3xl border border-violet-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-slate-800">Tes 2</h3>
